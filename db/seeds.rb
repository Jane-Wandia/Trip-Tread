...
user1 = User.create!(fullname: "Muriithi", email: "mk@gmail.com")
user2 = User.create!(fullname: "Jane", email: "Wandia@gmail.com")
user3 = User.create!(fullname: "Chelah", email: "Chelah@gmail.com")
